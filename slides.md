...
# Node.js + Email <br><span style="font-size: 35px">http://bit.ly/NodeEmail</span>
...
<li>slideshow from a single Markdown file</li>
<li>uses [deck.js](http://imakewebthings.com/deck.js/)</li>
</div>
<br>
...
<li>available on GitHub: https://github.com/mkopala/node-email-talk</li>
</div>
<br>

<div class="slide">
Error handling code is **minimal** or **non-existant**

<li>to keep things short</li>
<li>because I was too lazy to add it</li>
</div>
<br>
...
<li>I'm <b>not an expert</b> on any of this stuff!</li>
</div>


## Goals

<li class="slide">Cover basic concepts of email for threading & replies</li>
<li class="slide">Show how to handle email with node</li>
<li class="slide">Provide access to actual working example code</li>
...
<ul>
<li class="slide">sent email with node.js?</li>
<li class="slide">processed email with node.js?</li>
</ul>
...
<ul>
<li>Unique identifier for message.  </li>
<li>Generated by mailer or SMTP service.</li>
</ul>
</div>
...
`In-Reply-To`
<ul>
<li>Only present in email replies</li>
<li>Used to link email messages together </li>
</ul>
</div>
...
`References`
<ul>
<li>Message IDs for previous email in this thread</li>
</ul>
</div>
...
Sorry, I didn't get time for this.  

It's pretty easy with **nodemailer** and **mailparser** modules though ...
